...
const cupomController_1 = __importDefault(require("../modules/cupomController"));
...
const senhaController_1 = __importDefault(require("../modules/senhaController"));
const createCategorias_1 = __importDefault(require("../validations/categorias/createCategorias"));
const createCupom_1 = __importDefault(require("../validations/cupom/createCupom"));
...
const idResquestError_1 = __importDefault(require("../middlewares/idResquestError"));
const routes = (0, express_1.Router)();
routes.post("/login", login_1.default, authController_1.default.login);
routes.put("/login/senha/:id", auth_1.default, idResquestError_1.default, senhaController_1.default.update);
...
routes.get("/usuario/:id", auth_1.default, idResquestError_1.default, usuarioController_1.default.findOne);
routes.put("/usuario/:id", auth_1.default, idResquestError_1.default, usuarioController_1.default.update);
...
routes.put("/categoria/:id", auth_1.default, isAdminError_1.default, categoriaError_1.default, createCategorias_1.default, categoriaController_1.default.update);
...
routes.put("/livro/:id", auth_1.default, isAdminError_1.default, updateLivro_1.default, livroController_1.default.update);
routes.delete("/livro/:id", auth_1.default, isAdminError_1.default, livroController_1.default.delete);
routes.post("/cupom", auth_1.default, isAdminError_1.default, createCupom_1.default, cupomController_1.default.create);
routes.get("/cupom", auth_1.default, cupomController_1.default.findAll);
routes.get("/cupom/:id", auth_1.default, cupomController_1.default.findOne);
routes.put("/cupom/:id", auth_1.default, isAdminError_1.default, cupomController_1.default.update);
routes.delete("/cupom/:id", auth_1.default, isAdminError_1.default, cupomController_1.default.delete);

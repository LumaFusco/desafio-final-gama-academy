...
function Header() {
  ...
  return (
    <C.Container>
      <Navbar expand="lg">
        <Container>
          <Navbar.Brand href="#home" className="logo-loja"><LinkRoute to='/'>Teal Book</LinkRoute></Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link href="" className='link2'><LinkRoute to='/Livros'>Livros</LinkRoute> </Nav.Link>
          ...
          <div>
            <LinkRoute to='/carrinho'> <img src={imageCart} alt="cart icon" className="p-3 icon-cart" /></LinkRoute>
          </div>
        </Container>
      </Navbar>
    </C.Container >
